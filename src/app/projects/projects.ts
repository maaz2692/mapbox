...
export class Projects implements OnInit  {
  ...
  readTextFile(file: string, callback: Function) {
...
if (mapContainer) {
    ...
    //   'pk.eyJ1IjoibmF1bWFuMjE4IiwiYSI6ImNsbjl6dzNsODBiMnIyaXA1OTYwNTIwOWkifQ.RFhIuLDBIor2Sy_dQDLlDw';
    const map = new mapboxgl.Map({
      container: 'map',
      style: 'mapbox://styles/mapbox/streets-v12',
      accessToken: 'pk.eyJ1IjoibmF1bWFuMjE4IiwiYSI6ImNsbjl6dzNsODBiMnIyaXA1OTYwNTIwOWkifQ.RFhIuLDBIor2Sy_dQDLlDw',
...
getMLSZones() {
  ...
  //   this._data.setType('');
  //   this._data.setCity('');
  //   this.appComponent.displayFooter = true;
  //   this.projectService.setSearchResult('');
  // }
}
